...
<br> ISO Stylesheet Version: 5.7 Release Date: 01-31-2018</br>
<br/>
					...
					<div align="left">
						<font color="gray" face="arial" size="1">
CONFIDENTIAL
 <br> This report is for use by authorized users of ClaimSearch for the purposes permitted under the ClaimSearch Product Supplement/s, ISO Master Agreement and the ClaimSearch Privacy and Security Policies as updated.</br>
<br>© 2017 Insurance Services Office, Inc.</br>
<!--<br> ISO Stylesheet Version: 5.7 Release Date: 01-31-2018</br>-->
					</font>
					</div>
				</TABLE>
			...
			<xsl:choose>
				...
				<xsl:otherwise>
					...
					<xsl:for-each select="ClaimsParty[ClaimsPartyInfo/ClaimsPartyRoleCd = 'CL' or ClaimsPartyInfo/ClaimsPartyRoleCd 	= 	'CI' or ClaimsPartyInfo/ClaimsPartyRoleCd = 'CD' or ClaimsPartyInfo/ClaimsPartyRoleCd = 'CP' or 		ClaimsPartyInfo/ClaimsPartyRoleCd = 'ID' or ClaimsPartyInfo/ClaimsPartyRoleCd = 'IP' or ClaimsPartyInfo/ClaimsPartyRoleCd = 		'IE' or ClaimsPartyInfo/ClaimsPartyRoleCd = 'IN' or ClaimsPartyInfo/ClaimsPartyRoleCd = 'OW' or 		ClaimsPartyInfo/ClaimsPartyRoleCd = 'PT' or ClaimsPartyInfo/ClaimsPartyRoleCd = 'TN' or ClaimsPartyInfo/ClaimsPartyRoleCd = 		'WT' or ClaimsPartyInfo/ClaimsPartyRoleCd = 'CE' or ClaimsPartyInfo/ClaimsPartyRoleCd = 'GM']">
						...
						<!--
						<xsl:if test="string-length(normalize-space(../com.iso_NewSOD)) &gt; 0 ">
							<xsl:variable name="Echo_SOD" select="../com.iso_NewSOD"/>
							<xsl:call-template name="Insert_Data">
								<xsl:with-param name="Data_Name">Statement of Dispute</xsl:with-param>
								<xsl:with-param name="Data_Value">
									<xsl:value-of select="$Echo_SOD"/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:if>
						-->
...
-->
	<xsl:template name="Build_Property_Info">
		...
		<xsl:variable name="PropLossNode" select="$ClaimRoot/PropertyLossInfo[@ClaimsPartyRefs = $ClaimsPartyId]"/>
...
-->
	<xsl:template name="Build_Vehicle_Info">
		...
		<xsl:for-each select="$ClaimRoot/AutoLossInfo[@ClaimsPartyRefs= $ClaimsPartyId]">
			...
			<xsl:variable name="VehShipping" select="$ClaimRoot/InvestigationInfo[@ItemRef = $MV01Id]/AutoInvestigationInfo/EventInfo[EventCd='Shipping']/EventDt"/>
						...
						<xsl:choose>
							<xsl:when test="count($ClaimRoot/ClaimsPayment[@idref = $MV01Id][not(PaymentTypeCd)][ClaimsPaymentCovInfo/CoverageCd = 	$CoverageCode]) &gt; 0">
								<xsl:for-each select="$ClaimRoot/ClaimsPayment[@idref = $MV01Id][not(PaymentTypeCd)]	[ClaimsPaymentCovInfo/CoverageCd 	= 	$CoverageCode]">
									...
									<xsl:if test="$VinId = $VinId1 or  string-length(normalize-space($VehShipping)) &gt; 0 ">
