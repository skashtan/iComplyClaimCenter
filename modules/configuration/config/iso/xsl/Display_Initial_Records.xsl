...
-->
	<xsl:template name="Display_General_Info">
		...
		<xsl:variable name="ExtLossDesc" select="ClaimsOccurrence/com.iso_NewExtLossDesc"/>
		<xsl:if test="count($ExtLossDesc) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Extended Loss Description</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="ClaimsOccurrence/com.iso_NewExtLossDesc"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		...
		<xsl:if test="count(ClaimsParty[ClaimsPartyInfo/ClaimsPartyRoleCd = 'Emergency']/GeneralPartyInfo/NameInfo/CommlName/CommercialName) &gt;0">
			...
			<b>
				...
				<td align="left">
					...
					<xsl:if test="count(ClaimsOccurrence/ClaimsReported[@ReportedToRef = $PFReported2Ref]/ReportNumber) &gt;0 or count(ClaimsOccurrence/ClaimsReported/ReportNumber) &gt;0">
						<b>
							<font size="2" face="Arial">
					&#160;&#160;&#160;&#160;Report Case No.:
					</font>
						...
						<font size="2" face="Arial">
							<!--<xsl:value-of select="ClaimsOccurrence/ClaimsReported[@ReportedToRef = $PFReported2Ref]/ReportNumber"/>-->
							<xsl:value-of select="ClaimsOccurrence/ClaimsReported/ReportNumber"/>
						</font>
					</xsl:if>
				</td>
			</tr>
		...
		<!-- end -->
		<!-- CAT related,3Byte CAT number and 4 Byte CAT Number-->
		...
		<xsl:if test="count(ClaimsOccurrence/Catastrophe/CatastropheCd) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">3 Byte CAT Number</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="ClaimsOccurrence/Catastrophe/CatastropheCd"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<xsl:if test="count(ClaimsOccurrence/Catastrophe/com.iso_NewCATCd) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">4 Byte CAT Number</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="ClaimsOccurrence/Catastrophe/com.iso_NewCATCd"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
...
-->
	<xsl:template name="Display_sum_Involved_Party">
		...
		<xsl:variable name="casCMS" select="../com.iso_AddCovInfo/com.iso_CMS"/>
			...
			-->
					...
					<table border="0" width="650" cellpadding="0" cellspacing="0">
						...
						<xsl:if test="count(../AdjusterParty/AdjusterPartyInfo[@AssignmentRef = $MC01Id1]) &gt; 0">
							...
							<xsl:variable name="CasAdjid2" select="@AssignmentRef"/>
								...
								<xsl:if test="count($casCMS[@itemRef=$CasAdjid2]) &gt; 0">
										<tr>
											<td colspan="4" valign="top">
												<font face="arial" size="2" color="red">
													<b>Missing CMS Required Field:</b>
										...
										<tr>
											<td colspan="4">
												<font face="arial" size="2">
													<!--<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/COVERAGE-TYPES/*[@code=$CoverageCode]"/>-->
													<xsl:if test="count($casCMS[@itemRef=$CasAdjid2]/com.iso_CMSWarning) &gt;0">
													<!--<xsl:for-each select="$casCMS/com.iso_CMSWarning">-->
													<xsl:for-each select="$casCMS[@itemRef=$CasAdjid2]/com.iso_CMSWarning">
														<!--<xsl:value-of select="."/>-->
														<xsl:variable name="CMSWarning" select="."/>
														<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/CMSWarningCds/*[@code=$CMSWarning]"/>
														<!--<xsl:value-of select="position()!=last()">-->
...
-->
	<xsl:template name="Display_Involved_Party">
		...
		<xsl:variable name="MO01MaskBirthDate" select="PersonInfo/com.iso_MaskBirthDt"/>
		<xsl:if test="count($MO01MaskBirthDate) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">DOB</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="PersonInfo/com.iso_MaskBirthDt"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
...
-->
				...
				<td align="left">
					<font size="2" face="Arial">
						<xsl:choose>
							...
							<xsl:otherwise>XXX-XX-</xsl:otherwise>
						</xsl:choose>
						<xsl:number value="substring($SSNNum,6,4)" format="0001"/>
						<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/SSNValidationCds/*[@code=$SSNValidationCd]"/>
		...
		<xsl:variable name="TINNum" select="GeneralPartyInfo/NameInfo/TaxIdentity[TaxIdTypeCd = 'TIN']/TaxId"/>
		<xsl:variable name="TINValidationCd" select="PartyInvestigationInfo/TINValidationCd"/>
		<xsl:variable name="MaskTIN" select="substring($TINNum,1,5)"/>
		<xsl:if test="count($TINNum) &gt; 0">
			<tr>
				<td align="left">&#160;&#160;
				<b>
				...
				<td align="left">
					<font size="2" face="Arial">
						...
						<xsl:number value="substring($TINNum,3,7)" format="0000001"/>-->
						<xsl:choose>
							<xsl:when test="$MaskTIN != 00000">
								<xsl:number value="substring($TINNum,1,2)" format="01-"/>
								<xsl:number value="substring($TINNum,3,3)" format="001"/>
							</xsl:when>
							<xsl:otherwise>XX-XXX</xsl:otherwise>
						</xsl:choose>
						<xsl:number value="substring($TINNum,6,4)" format="0001"/>
						<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/TINValidationCds/*[@code=$TINValidationCd]"/>
		...
		<xsl:if test="count($HICN) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">HICN or MBI</xsl:with-param>
				<xsl:with-param name="Data_Value">
		...
		<xsl:variable name="PartyRoleCd" select="ClaimsPartyInfo/ClaimsPartyRoleCd"/>
		<xsl:variable name="DriverLicClass" select="ClaimsDriverInfo/DriversLicense/LicenseClassCd"/>
		<xsl:if test="count($DriverLicClass) &gt; 0 and $PartyRoleCd != 'Alias' ">
			<xsl:call-template name="Insert_Data_Using_Code_List">
				<xsl:with-param name="Data_Name">Driver's License Class</xsl:with-param>
				<!--
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="$DriverLicClass"/>
				</xsl:with-param>
				-->
				<xsl:with-param name="Data_Code">
					<xsl:value-of select="$DriverLicClass"/>
				...
				<xsl:with-param name="Data_Code_Value">
					<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/DriverLicClassCds/*[@code=$DriverLicClass]"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<xsl:variable name="MO01occ" select="PersonInfo/OccupationDesc"/>
		<xsl:if test="count($MO01occ) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Occupation</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="$MO01occ"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<xsl:call-template name="Insert_Data">
			<!--<xsl:with-param name="Data_Name">Med./Prof. License</xsl:with-param>-->
			<xsl:with-param name="Data_Name">Medical/NPI or Prof. License</xsl:with-param>
			<xsl:with-param name="Data_Value">
...
-->
	<xsl:template name="Display_Alias">
		...
		<xsl:variable name="MaskBirthDate" select="PersonInfo/com.iso_MaskBirthDt"/>
		<xsl:if test="count($MaskBirthDate) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">DOB</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="PersonInfo/com.iso_MaskBirthDt"/>
		...
		<xsl:variable name="AKA_DriverLicClass" select="ClaimsDriverInfo/DriversLicense/LicenseClassCd"/>
		<xsl:variable name="AKARoleCd" select="ClaimsPartyInfo/ClaimsPartyRoleCd"/>
		<xsl:if test="count($AKA_DriverLicClass) &gt; 0 and $AKARoleCd= 'Alias' ">
			<xsl:call-template name="Insert_Data_Using_Code_List">
				<xsl:with-param name="Data_Name">Driver's License Class</xsl:with-param>
				<xsl:with-param name="Data_Code">
					<xsl:value-of select="$AKA_DriverLicClass"/>
				</xsl:with-param>
				<xsl:with-param name="Data_Code_Value">
					<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/DriverLicClassCds/DriverLicClassCd[@code=$AKA_DriverLicClass]"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>	
...
-->
	<xsl:template name="Display_Service_Provider">
		...
		<xsl:variable name="MSP1MaskBirthDt" select="PersonInfo/com.iso_MaskBirthDt"/>
		<xsl:if test="count($MSP1MaskBirthDt) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">DOB</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="PersonInfo/com.iso_MaskBirthDt"/>
...
-->
	<xsl:template name="Display_Casualy_Info">
		...
		<xsl:if test="string-length(normalize-space($AdjusterNode)) &gt; 0">
			...
			<xsl:variable name="AdjEmail" select="$AdjusterNode/../GeneralPartyInfo/Communications/EmailInfo[@idref=$InjInfoId]/EmailAddr"/>
			<xsl:if test="count($AdjEmail) &gt; 0">
				<xsl:call-template name="Insert_Adjuster">
					<xsl:with-param name="AdjusterEmail">
						<xsl:value-of select="$AdjEmail"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
		</xsl:if>
		...
		<xsl:variable name="ERISAClaimInd" select="$ClaimsInjNode[@id=$InjInfoId]/ClaimsInjury/com.iso_ERISAClmInd"/>
		<xsl:if test= "count($ERISAClaimInd) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">ERISA Claim</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:if test="$ERISAClaimInd =0 or $ERISAClaimInd ='N'">NO</xsl:if>
					<xsl:if test="$ERISAClaimInd =1 or $ERISAClaimInd ='Y'">YES</xsl:if>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
...
-->
	<xsl:template name="Display_Property">
		...
		<xsl:variable name="AdjEmail" select="$AdjusterNode/../GeneralPartyInfo/Communications/EmailInfo[@idref=$MP01Id]/EmailAddr"/>
			<xsl:if test="count($AdjEmail) &gt; 0">
				<xsl:call-template name="Insert_Adjuster">
					<xsl:with-param name="AdjusterEmail">
						<xsl:value-of select="$AdjusterNode/../GeneralPartyInfo/Communications/EmailInfo[@idref=$MP01Id]/EmailAddr"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
		<xsl:call-template name="Insert_Data">
...
-->
	<xsl:template name="Display_Water_Mobile_Property">
		...
		<xsl:variable name="AdjEmail" select="$AdjusterNode/../GeneralPartyInfo/Communications/EmailInfo[@idref = $WaterCraftId or @idref = $MobileId or @idref = $PropLossInfoId]/EmailAddr"/>
		<xsl:if test="count($AdjEmail) &gt; 0">
			<xsl:call-template name="Insert_Adjuster">
				<xsl:with-param name="AdjusterEmail">
					<xsl:value-of select="$AdjEmail"/>
		...
		<xsl:if test="count($MobileYear) &gt; 0 or count($MobileMake) &gt; 0 or count($MobileModel) &gt; 0 or count($MobileVehStyle) &gt; 0 or count($MobileVIN) &gt; 0 or count($MobileEngSerial) &gt; 0 or count($MobileChasisNum) &gt; 0 or count($MobileTransNum) &gt; 0">
			...
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">PIN/HIN/VIN</xsl:with-param>
				<xsl:with-param name="Data_Value">
...
-->
	<xsl:template name="Display_Vehicle_Info">
		...
		<xsl:variable name="AdjEmail" select="$AdjusterNode/../GeneralPartyInfo/Communications/EmailInfo[@idref = $MV01Id]/EmailAddr"/>
		<xsl:if test="count($AdjEmail) &gt; 0">
			<xsl:call-template name="Insert_Adjuster">
				<xsl:with-param name="AdjusterEmail">
					<xsl:value-of select="$AdjEmail"/>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				...
				<xsl:variable name="RecoveryClass" select="$InvestigationNode/RecoveryInfo[@ItemRef = $MV01Id]/RecoveryStatusCd[@codelistref ='RecoveryClassificationCdList'] | $ClaimRoot/RecoveryInfo[@ItemRef = $MV01Id]/RecoveryStatusCd[@codelistref ='RecoveryClassificationCdList']"/>
...
-->
	<xsl:template name="Display_Vehicle_Shipping">
		...
		<xsl:param name="InvestigationNode"/>
		<xsl:param name="ClaimsPartyId"/>
		<xsl:variable name="MV04Id" select="$VehLossNode/@id"/>
		...
		<xsl:if test="string-length(normalize-space($ClaimRoot/InvestigationInfo/AutoInvestigationInfo/ShippedConditionDesc)) &gt; 0 or string-length(normalize-space($ClaimRoot/InvestigationInfo/AutoInvestigationInfo/EventInfo[EventCd = 'Shipping']/EventDt)) &gt; 0 ">
			...
			<xsl:if test="count($ClaimRoot/AutoLossInfo[not(@ClaimsPartyRefs)]/VehInfo/VehIdentificationNumber) &gt; 0 or count($ClaimRoot/AutoLossInfo[@id = $MV04Id]/VehInfo/VehIdentificationNumber) &gt; 0">
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">VIN</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="$ClaimRoot/AutoLossInfo[not(@ClaimsPartyRefs)]/VehInfo/VehIdentificationNumber | $ClaimRoot/AutoLossInfo[@id = $MV04Id]/VehInfo/VehIdentificationNumber"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
			<xsl:variable name="MV04VehYear" select="$ClaimRoot/AutoLossInfo[@id = $MV04Id]/VehInfo/ModelYear"/>
			<xsl:variable name="MV04VehMake" select="$ClaimRoot/AutoLossInfo[@id = $MV04Id]/VehInfo/Manufacturer"/>
			<xsl:variable name="MV04VehModel" select="$ClaimRoot/AutoLossInfo[@id = $MV04Id]/VehInfo/Model"/>
			...
			<xsl:if test="count($VehYear) &gt; 0 or count($VehMake) &gt; 0 or count($VehModel) &gt; 0 or count($MV04VehYear) &gt; 0 or count($MV04VehMake) &gt; 0 or count($MV04VehModel) &gt; 0">
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">Vehicle</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="$VehYear|$MV04VehYear"/>&#160;<xsl:value-of select="$VehMake | $MV04VehMake"/>&#160;<xsl:value-of select="$VehModel | $MV04VehModel"/>
					</xsl:with-param>
				</xsl:call-template>
			</xsl:if>
			<!--
	...
	<xsl:template name="Display_Vehicle_Add_Recovery">
		...
		<xsl:if test="($RecLoc > 0) or ($VehRef > 0) or ($RecTxt > 0) or ($RecLoc1 > 0) or ($VehRef1 > 0) or ($RecTxt1 > 0) ">
			...
			<xsl:call-template name="Insert_Data">
				...
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="$ClaimRoot/RecoveryInfo[@ItemRef = $InvId]/com.iso_RecoveryVehNumber  | $InvestigationNode/RecoveryInfo/com.iso_RecoveryVehNumber"/>
				</xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="Insert_Data">
