...
-->
	<xsl:template name="Display_Matching_Involved_Party">
		...
		<xsl:variable name="MO02MaskBirthDate" select="PersonInfo/com.iso_MaskBirthDt"/>
		<xsl:if test="count($MO02MaskBirthDate) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">DOB</xsl:with-param>
				<xsl:with-param name="Data_Value">
	...
	<xsl:if test="count($MO02DeathDt) &gt; 0">
		...
		<xsl:variable name="MO02occ" select="PersonInfo/OccupationDesc"/>
		<xsl:if test="count($MO02occ) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Occupation</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="$MO02occ"/>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<xsl:call-template name="Insert_Data">
...
-->
	<xsl:template name="Display_Matching_Alias">
		...
		<xsl:variable name="MK02MaskBirthDt" select="PersonInfo/com.iso_MaskBirthDt"/>
		<xsl:if test="count($MK02MaskBirthDt) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">DOB</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="PersonInfo/com.iso_MaskBirthDt"/>
...
-->
	<xsl:template name="Display_Matching_Service_Provider">
		...
		<xsl:variable name="MSP2MaskBirthDt" select="PersonInfo/com.iso_MaskBirthDt"/>
		<xsl:if test="count($MSP2MaskBirthDt) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">DOB</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="PersonInfo/com.iso_MaskBirthDt"/>
...
-->
	<xsl:template name="Display_Matching_Casualty_Info">
		...
		<xsl:if test="string-length(normalize-space($AdjusterNode)) &gt; 0">
			...
			<xsl:variable name="AdjEmail" select="$AdjusterNode/../GeneralPartyInfo/Communications/EmailInfo[@idref = $MC01Id]/EmailAddr"/>
		...
		<xsl:variable name="ERISAClaimInd" select="$ClaimsInjNode/ClaimsInjury/com.iso_ERISAClmInd"/>
...
-->
	<xsl:template name="Display_Matching_Boat_Mobile_Property">
		...
		<xsl:variable name="AdjEmail" select="$AdjusterNode/../GeneralPartyInfo/Communications/EmailInfo[@idref = $WaterCraftId or @idref = $MobileId]/EmailAddr"/>
		<xsl:if test="count($AdjEmail) &gt; 0">
			<xsl:call-template name="Insert_Adjuster">
				<xsl:with-param name="AdjusterEmail">
					<xsl:value-of select="$AdjEmail"/>
