...
final class TransactionDTO {
   ...
   */
  final function writeTo<T extends Transaction>(that: T, ignoreNullValues = true): T {
    // if field is on base class
   ...
   */
  final function writeToNewEntityIn<T extends Transaction>(bundleProvider: BundleProvider, createNew: block(): T = null, ignoreNullValues = true): T {
    var instance: T
