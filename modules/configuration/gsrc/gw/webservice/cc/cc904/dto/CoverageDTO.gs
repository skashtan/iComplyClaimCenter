...
final class CoverageDTO {
   ...
   */
  final function writeTo<T extends Coverage>(that: T, ignoreNullValues = true): T {
    // if field is on base class
   ...
   */
  final function writeToNewEntityIn<T extends Coverage>(bundleProvider: BundleProvider, createNew: block(): T = null, ignoreNullValues = true): T {
    var instance: T
