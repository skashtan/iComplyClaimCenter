...
final class ContactDTO {
   ...
   */
  final function writeTo<T extends Contact>(that: T, ignoreNullValues = true): T {
    // if field is on base class
   ...
   */
  final function writeToNewEntityIn<T extends Contact>(bundleProvider: BundleProvider, createNew: block(): T = null, ignoreNullValues = true): T {
    var instance: T
