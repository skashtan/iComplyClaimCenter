...
final class IncidentDTO {
   ...
   */
  final function writeTo<T extends Incident>(that: T, ignoreNullValues = true): T {
    // if field is on base class
   ...
   */
  final function writeToNewEntityIn<T extends Incident>(bundleProvider: BundleProvider, createNew: block(): T = null, ignoreNullValues = true): T {
    var instance: T
