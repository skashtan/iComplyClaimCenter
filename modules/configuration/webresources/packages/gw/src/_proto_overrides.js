...
Ext.util.Event.prototype.fire = function() {
    ...
    // We don't allow shortcuts with ctrlKey anyways, but browsers without support for Alt-Gr key
    // return true on alt and true and ctrl when the Alt-Gr key is pressed.
    // So we need to ignore it as alt when they are in a text input.
    if (arguments[0] && arguments[0].ctrlKey && arguments[0].altKey) {
        return;
    }
