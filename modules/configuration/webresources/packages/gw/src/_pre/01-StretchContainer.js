...
Ext.define('gw.container.StretchContainer', {
    ...
    initComponent: function() {
        ...
        // link Toobar need to be call before callParent so onChange event handler can be registered properly in components.
        if(me.bbar) {
            gw.Util.linkBottomAndTopToolbar(me);
        }

        me.callParent(arguments);

        // include the toolbar, and disable toolbar overflow:
        // It need to be called after callParent after components are created
        if (me.tbar) {
